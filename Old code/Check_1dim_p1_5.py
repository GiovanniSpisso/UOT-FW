...
# Generate test data
np.random.seed(0)
mu = np.random.randint(1, 100, size=n).astype(float)
nu = np.random.randint(1, 100, size=n).astype(float)
...
# Initialize
xk, x_marg, y_marg = fw_p1_5.x_init_p1_5(mu, nu, n)
grad_xk = fw_p1_5.grad_p1_5(x_marg, y_marg, n)
